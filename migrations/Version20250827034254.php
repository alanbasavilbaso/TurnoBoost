 ...
 */
final class Version20250827034254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clinics (id SERIAL NOT NULL, created_by_id INT NOT NULL, name VARCHAR(255) NOT NULL, address VARCHAR(255) DEFAULT NULL, phone VARCHAR(50) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_D7053B66B03A8386 ON clinics (created_by_id)');
        ...
        $this->addSql('CREATE TABLE patients (id SERIAL NOT NULL, clinic_id INT NOT NULL, name VARCHAR(255) NOT NULL, phone VARCHAR(50) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, notes TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_2CCC2E2CCC22AD4 ON patients (clinic_id)');
        ...
        $this->addSql('CREATE TABLE professional_services (id SERIAL NOT NULL, professional_id INT NOT NULL, service_id INT NOT NULL, custom_duration_minutes INT DEFAULT NULL, custom_price NUMERIC(10, 2) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE professionals (id SERIAL NOT NULL, clinic_id INT NOT NULL, name VARCHAR(255) NOT NULL, specialty VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, phone VARCHAR(50) DEFAULT NULL, active BOOLEAN DEFAULT true NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_2DBE308ECC22AD4 ON professionals (clinic_id)');
        ...
        $this->addSql('CREATE TABLE services (id SERIAL NOT NULL, clinic_id INT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, default_duration_minutes INT NOT NULL, price NUMERIC(10, 2) DEFAULT NULL, active BOOLEAN DEFAULT true NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_7332E169CC22AD4 ON services (clinic_id)');
        $this->addSql('CREATE TABLE users (id SERIAL NOT NULL, clinic_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password_hash VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1483A5E9E7927C74 ON users (email)');
        $this->addSql('CREATE INDEX IDX_1483A5E9CC22AD4 ON users (clinic_id)');
        ...
        $this->addSql('ALTER TABLE appointments ADD CONSTRAINT FK_6A41727ACC22AD4 FOREIGN KEY (clinic_id) REFERENCES clinics (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE clinics ADD CONSTRAINT FK_D7053B66B03A8386 FOREIGN KEY (created_by_id) REFERENCES users (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE patients ADD CONSTRAINT FK_2CCC2E2CCC22AD4 FOREIGN KEY (clinic_id) REFERENCES clinics (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE professionals ADD CONSTRAINT FK_2DBE308ECC22AD4 FOREIGN KEY (clinic_id) REFERENCES clinics (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE services ADD CONSTRAINT FK_7332E169CC22AD4 FOREIGN KEY (clinic_id) REFERENCES clinics (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE users ADD CONSTRAINT FK_1483A5E9CC22AD4 FOREIGN KEY (clinic_id) REFERENCES clinics (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE appointments DROP CONSTRAINT FK_6A41727ACC22AD4');
        ...
        $this->addSql('ALTER TABLE clinics DROP CONSTRAINT FK_D7053B66B03A8386');
        ...
        $this->addSql('ALTER TABLE patients DROP CONSTRAINT FK_2CCC2E2CCC22AD4');
        ...
        $this->addSql('ALTER TABLE professionals DROP CONSTRAINT FK_2DBE308ECC22AD4');
        $this->addSql('ALTER TABLE schedule_blocks DROP CONSTRAINT FK_ACCCD167DB77003');
        $this->addSql('ALTER TABLE services DROP CONSTRAINT FK_7332E169CC22AD4');
        $this->addSql('ALTER TABLE users DROP CONSTRAINT FK_1483A5E9CC22AD4');
