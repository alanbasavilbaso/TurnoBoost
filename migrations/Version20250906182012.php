 ...
 */
final class Version20250906182012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE appointments (id SERIAL NOT NULL, company_id INT NOT NULL, location_id INT NOT NULL, professional_id INT NOT NULL, patient_id INT DEFAULT NULL, service_id INT DEFAULT NULL, scheduled_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, duration_minutes INT NOT NULL, price NUMERIC(10, 2) DEFAULT NULL, status VARCHAR(255) NOT NULL, notes TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_6A41727A979B1AD6 ON appointments (company_id)');
        ...
        $this->addSql('CREATE TABLE companies (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, active BOOLEAN DEFAULT true NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE locations (id SERIAL NOT NULL, company_id INT NOT NULL, created_by_id INT NOT NULL, name VARCHAR(255) NOT NULL, address VARCHAR(255) DEFAULT NULL, phone VARCHAR(50) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, domain VARCHAR(100) NOT NULL, active BOOLEAN DEFAULT true NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_17E64ABAA7A91E0B ON locations (domain)');
        $this->addSql('CREATE INDEX IDX_17E64ABA979B1AD6 ON locations (company_id)');
        $this->addSql('CREATE INDEX IDX_17E64ABAB03A8386 ON locations (created_by_id)');
        $this->addSql('CREATE TABLE notifications (id SERIAL NOT NULL, appointment_id INT NOT NULL, type VARCHAR(255) NOT NULL, template_used VARCHAR(255) DEFAULT NULL, sent_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, scheduled_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_6000B0D3E5B533F9 ON notifications (appointment_id)');
        $this->addSql('CREATE TABLE patients (id SERIAL NOT NULL, company_id INT NOT NULL, id_document VARCHAR(50) DEFAULT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, birthdate DATE DEFAULT NULL, phone VARCHAR(50) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, notes TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_2CCC2E2C979B1AD6 ON patients (company_id)');
        ...
        $this->addSql('CREATE TABLE professionals (id SERIAL NOT NULL, company_id INT NOT NULL, name VARCHAR(255) NOT NULL, specialty VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, phone VARCHAR(50) DEFAULT NULL, active BOOLEAN DEFAULT true NOT NULL, online_booking_enabled BOOLEAN DEFAULT true NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_2DBE308E979B1AD6 ON professionals (company_id)');
        ...
        $this->addSql('CREATE TABLE services (id SERIAL NOT NULL, company_id INT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, default_duration_minutes INT NOT NULL, price NUMERIC(10, 2) DEFAULT NULL, active BOOLEAN DEFAULT true NOT NULL, online_booking_enabled BOOLEAN DEFAULT true NOT NULL, reminder_note TEXT DEFAULT NULL, delivery_type VARCHAR(255) DEFAULT \'in_person\' NOT NULL, service_type VARCHAR(255) DEFAULT \'regular\' NOT NULL, frequency_weeks INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_7332E169979B1AD6 ON services (company_id)');
        $this->addSql('CREATE TABLE settings (id SERIAL NOT NULL, company_id INT NOT NULL, minimum_booking_time INT NOT NULL, maximum_future_time INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E545A0C5979B1AD6 ON settings (company_id)');
        $this->addSql('CREATE TABLE users (id SERIAL NOT NULL, company_id INT NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password_hash VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, is_owner BOOLEAN DEFAULT false NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE appointments ADD CONSTRAINT FK_6A41727A979B1AD6 FOREIGN KEY (company_id) REFERENCES companies (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE locations ADD CONSTRAINT FK_17E64ABA979B1AD6 FOREIGN KEY (company_id) REFERENCES companies (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE patients ADD CONSTRAINT FK_2CCC2E2C979B1AD6 FOREIGN KEY (company_id) REFERENCES companies (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE professionals ADD CONSTRAINT FK_2DBE308E979B1AD6 FOREIGN KEY (company_id) REFERENCES companies (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE services ADD CONSTRAINT FK_7332E169979B1AD6 FOREIGN KEY (company_id) REFERENCES companies (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE settings ADD CONSTRAINT FK_E545A0C5979B1AD6 FOREIGN KEY (company_id) REFERENCES companies (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE appointments DROP CONSTRAINT FK_6A41727A979B1AD6');
        ...
        $this->addSql('ALTER TABLE locations DROP CONSTRAINT FK_17E64ABA979B1AD6');
        ...
        $this->addSql('ALTER TABLE patients DROP CONSTRAINT FK_2CCC2E2C979B1AD6');
        ...
        $this->addSql('ALTER TABLE professionals DROP CONSTRAINT FK_2DBE308E979B1AD6');
        $this->addSql('ALTER TABLE schedule_blocks DROP CONSTRAINT FK_ACCCD167DB77003');
        $this->addSql('ALTER TABLE services DROP CONSTRAINT FK_7332E169979B1AD6');
        $this->addSql('ALTER TABLE settings DROP CONSTRAINT FK_E545A0C5979B1AD6');
